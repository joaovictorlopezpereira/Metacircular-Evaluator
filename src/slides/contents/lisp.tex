...
\begin{frame}
  ...
  \begin{itemize}
    \item Criada em 1958 para manipulação simbólica, baseada no Cálculo Lambda (\emph{Lambda Papers}); \vspace{1cm}
    \pause
...
% Maybe add one of this functions as a tree for better visualization
